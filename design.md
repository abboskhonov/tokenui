...
Iteration Guide
Always use shadow-as-border instead of CSS border — 0px 0px 0px 1px rgba(0,0,0,0.08) is the foundation
Letter-spacing scales with font size: -2.4px at 48px, -1.28px at 32px, -0.96px at 24px, normal at 14px
...
The inner #fafafa ring in card shadows is what gives Vercel cards their subtle inner glow
Geist Mono uppercase for technical labels, Geist Sans for everything else